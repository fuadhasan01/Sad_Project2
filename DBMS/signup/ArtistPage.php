      ...
      <div class="profile">
        <ul class="uls">
          ...
          <ul class="dropdown">
            ...
            <hr>
            <li><a href="Add Art/addArt.php">Add Art <b>+</b></a></li>
            <li><a href="Add Art/personalArtView.php">My Art</a></li>
            <li><a href="Edit Profile/editProfile1.php">Edit Profile</a></li>
