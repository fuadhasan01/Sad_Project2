...
<div class="bart">
    <div class="card2">
           ...
           <div class="alb">
            <?php
              $q1 = "SELECT * FROM art WHERE id=(SELECT MAX(a_id) FROM vote)";
              ...
              $u_id = $best_art['user'];
              $q2 = "SELECT * FROM user_form WHERE id='$u_id'";
             ...
             ?>
            <p style="text-align:center;font-size: 30px;color: #375545;margin-top: 10px;">Best Art</p>
            <!-- Need Modificaion (Art) -->
              <img src="uploads/<?=$best_art['url']?>">
             <br>
           </div>
        ...
        <div class="card2">
                 ...
                 <div class="alb">
                    <p style="margin-left: 145px; font-size: 30px;color: #375545;margin-top: 10px;">Best Artist</p>
                   <br>
                 
                  <p style="margin-left: 30px;"><b>Name: </b><?php echo $best_art['name'] ?></p>
                   
                  <p style="margin-left: 30px;"><b>Artist Name : </b><?php echo $best_art_artist['name'] ?></p>
        ...
        if(isset($_GET['search']))
            ...
            if (mysqli_num_rows($res) > 0) {
              while ($images = mysqli_fetch_assoc($res)) {  ?>
               <a style=" color: black;" href="artdetails.php?p=<?php echo $images['id']; ?>">
               <div class="card1"> 
                 <div class="alb">
                 ...
                 <div class="artistName">
                  <p><b>Artist Name : </b><?php echo $images['u_name'] ?></p>
          ...
          <?php } }
                ...
                ?>
                   <h5 style="margin-left: 43%;color: #375554;">No Search Record Found!</h5>
                <?php
                        }
                ?>
    </div>
